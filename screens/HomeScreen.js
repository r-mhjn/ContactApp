...
export default class HomeScreen extends React.Component {
  ...
  // adding a listner to navigation screen ...as soon as the screne gains focus
  componentWillMount(){
      ...
      await AsyncStorage.getAllKeys()
        .then(keys =>{
          ...
          return AsyncStorage.multiGet(keys)
           ...
           .catch(error => {
             console.log("Error for multiget" +error);
           })

        })
        .catch(error => console.log("Error in getAllContact"+error))
         console.log(this.state.data);
  }


  
   //keyExtractor has an access to data and its index
  render(){
  return (
