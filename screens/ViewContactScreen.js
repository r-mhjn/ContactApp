...
export default class ViewContactScreen extends React.Component {
  ...
  componentDidMount(){
    ...
    navigation.addListener("willFocus", ()=>{
      ...
      //TODO: call a method to populate or to use key
      this.getContact(key);
  ...
  getContact = async(key) =>{
    await AsyncStorage.getItem(key)
      .then(contactjsonString =>{
         ...
         contact["key"] = key; 
         this.setState(contact); // this contact is a JSON object ..directly setting state of contact sets the state of all the parameters in this.state in the constructor
      })
      .catch(error=>{
        console.log("Error while gettting contact details "+ error)
      })
  };
  ...
  callAction = (phone) =>{
    ...
    Linking.canOpenURL(phoneNumber)
      ...
      .catch(err => console.log("Error while linking call screen "+ err))
  };
  ...
  smsAction = (phone) =>{
    ...
    Linking.canOpenURL(phoneNumber)
      ...
      .catch(err => console.log("Error while linking sms screen "+ err))
  }
         ...
         text:"OK",
          onPress: async () =>{
             await AsyncStorage.removeItem(key)
                ...
                .catch(err=> console.log("error while deleting the error"))
          }
       }
